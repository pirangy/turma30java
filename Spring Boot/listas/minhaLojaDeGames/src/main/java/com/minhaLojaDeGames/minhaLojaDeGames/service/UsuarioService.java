...
public class UsuarioService {
	...
	public Optional <Usuario> CadastrarUsuario (Usuario usuario) {
		...
		//Esses procedimentos foram alterados a partir das vídeo-aulas 
		//de modo que a aplicação não permita o cadastro de usuários já existentes no banco de dados
